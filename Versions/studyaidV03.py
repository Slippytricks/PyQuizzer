...
def get_subjects():
    '''Return a list of directories in specified folder.'''
    subs = os.listdir('subjects\\')
    # Uncomment to remove SAMPLE subject
##    subs.remove('SAMPLE')
    # Removes the README.txt
    subs.remove('README.txt')
    # This is not changing a list while iterating over it, this uses
    # the amount of items in the list(an integer) to iterate that many times.
    '''i is used to access and format the list index'''
